...
import { addTransaction, updateTransaction, deleteTransaction, getAllTransactions, getTransactionsByMonth, getRecentTransactions, getCategories, addCategory, deleteCategory, getBalance, getMonthlySummary, getAllSettings, getSetting, setSetting, getAllBudgets, setBudget, getBudgetForMonth, exportAllData, clearAllData } from './db.js';
...
document.addEventListener('DOMContentLoaded', async function() {
  ...
  var sc = document.getElementById('setting-currency');
  if (sc) sc.addEventListener('click', changeCurrency);
